...
INSERT into FORMAS_DE_PAGAMENTO values ('fp01', 'Boleto Bancario', 10, 300); -- rever
INSERT into FORMAS_DE_PAGAMENTO values ('fp02', 'Boleto Bancario', 0, 1);
INSERT into FORMAS_DE_PAGAMENTO values ('fp03', 'Cartao de Credito', 0, 200);
INSERT into FORMAS_DE_PAGAMENTO values ('fp04', 'Cartao de Credito', 5, 1);
INSERT into FORMAS_DE_PAGAMENTO values ('fp05', 'Cartao de Credito', 0, 1);
INSERT into FORMAS_DE_PAGAMENTO values ('fp06', 'Cartao de Debito', 0, 1);
INSERT into FORMAS_DE_PAGAMENTO values ('fp07', 'Cartao de Debito', 0, 1);
INSERT into FORMAS_DE_PAGAMENTO values ('fp08', 'PayPal', 10, 1);
INSERT into FORMAS_DE_PAGAMENTO values ('fp09', 'PayPal', 0, 1);
INSERT into FORMAS_DE_PAGAMENTO values ('fp10', 'PayPal', 5, 1);
...
-- CATEGORIZACAO: 'idCategoria','idPropriedade'
INSERT into CATEGORIZACAO value('ct01', 'pr01');
INSERT into CATEGORIZACAO value('ct01', 'pr03');
INSERT into CATEGORIZACAO value('ct01', 'pr05');
INSERT into CATEGORIZACAO value('ct01', 'pr10');
INSERT into CATEGORIZACAO value('ct02', 'pr01');
INSERT into CATEGORIZACAO value('ct02', 'pr02');
INSERT into CATEGORIZACAO value('ct02', 'pr04');
INSERT into CATEGORIZACAO value('ct02', 'pr05');
INSERT into CATEGORIZACAO value('ct02', 'pr06');
INSERT into CATEGORIZACAO value('ct02', 'pr07');
INSERT into CATEGORIZACAO value('ct02', 'pr08');
INSERT into CATEGORIZACAO value('ct02', 'pr09');
INSERT into CATEGORIZACAO value('ct03', 'pr01');
INSERT into CATEGORIZACAO value('ct03', 'pr02');
INSERT into CATEGORIZACAO value('ct03', 'pr08');
INSERT into CATEGORIZACAO value('ct04', 'pr11');
INSERT into CATEGORIZACAO value('ct04', 'pr12');
INSERT into CATEGORIZACAO value('ct05', 'pr11');
INSERT into CATEGORIZACAO value('ct06', 'pr13');
INSERT into CATEGORIZACAO value('ct07', 'pr11');
INSERT into CATEGORIZACAO value('ct08', 'pr13');
INSERT into CATEGORIZACAO value('ct09', 'pr11');
INSERT into CATEGORIZACAO value('ct10', 'pr14');
INSERT into CATEGORIZACAO value('ct11', 'pr01');
INSERT into CATEGORIZACAO value('ct11', 'pr03');
INSERT into CATEGORIZACAO value('ct11', 'pr05');
INSERT into CATEGORIZACAO value('ct12', 'pr06');
...
INSERT into CUPOM_DE_DESCONTO values('cd02', '2018-12-31', 30, 'ct04'); -- desconto de 30% em maquina de lavar
...
INSERT into CUPOM_DE_DESCONTO values('cd08', '2020-06-15', 5, 'ct09');  
INSERT into CUPOM_DE_DESCONTO values('cd09', '2019-03-30', 10);
INSERT into CUPOM_DE_DESCONTO values('cd10', '2019-11-06', 50);
...
INSERT into PEDIDO value ('pd00000001', 261, '2018-11-23', '01517112056', 'fp01'); -- pr00000001 10% desconto pelo boleto
INSERT into PEDIDO value ('pd00000002', 5641, '2018-11-23', '01517112056', 'fp02'); -- pr00000003 + pr00000023 boleto
INSERT into PEDIDO value ('pd00000003', 2999, '2018-11-23', '01517112056', 'fp08'); -- pr00000005 PayPal
INSERT into PEDIDO value ('pd00000004', 2420, '2018-11-23', '01517112056', 'fp08');
INSERT into PEDIDO value ('pd00000005', 5641, '2018-11-23', '01517112056', 'fp01');
INSERT into PEDIDO value ('pd00000006', 5641, '2018-11-23', '01517112056', 'fp01');
INSERT into PEDIDO value ('pd00000007', 5641, '2018-11-23', '01517112056', 'fp01');
INSERT into PEDIDO value ('pd00000008', 5641, '2018-11-23', '01517112056', 'fp01');
INSERT into PEDIDO value ('pd00000009', 5641, '2018-11-23', '01517112056', 'fp01');
INSERT into PEDIDO value ('pd00000010', 5641, '2018-11-23', '01517112056', 'fp01');

-- PRODUTO: 'idProduto','nomeProduto','marca',preco,'idCategoria','cnpjVendedor','cnpjEntregador','fichaTecnica','idOferta'
...
INSERT into PRODUTO values('pr00000011', 'Maquina de Lavar Brastemp',       'BRASTEMP',     2729.00,    90, 'ct04', '67457503000161', '67457503000161', 'Nome da marca: Brastemp, Peso do produto:45,4 g, Dimensões do produto: 10 x 10 x 10 cm, Número da peça: BWN15AK, Voltagem: 110 volts, Peso: 45.4 g');
...
INSERT into PRODUTO values('pr00000014', 'Geladeira Cycle Defrost Duplex',  'CONSUL',       2889.00,    84, 'ct05', '63557512000135', '63557512000135', 'Nome da marca: Consul, Peso do produto: 72 Kg, Dimensões do produto: 10 x 10 x 10 cm, Número da peça: 1218, Voltagem: 220 volts');
...
INSERT into PRODUTO values('pr00000016', 'Fogao Brastemp',                  'BRASTEMP',     1579.00,    80, 'ct06', '67457503000161', '67457503000161', 'Nome da marca: Brastemp, Peso do produto: 31,8 g, Dimensões do produto: 10 x 10 x 10 cm, Número da peça: 1055');
INSERT into PRODUTO values('pr00000017', 'Microondas Philco',               'PHILCO',       880.00,     17, 'ct07', '46515978000156', '46515936000156', 'Nome da marca: Philco, Número da peça: 7891356058646, Peso do produto: 15 Kg');
...
INSERT into PRODUTO values('pr00000019', 'Cooktop 4 Bocas Brastemp Ative!', 'BRASTEMP',     777.00,     29, 'ct08', '67457503000161', '67457503000161', 'Nome da marca: BRASTEMP, Número da peça: 4452');
...
INSERT into PRODUTO values('pr00000022', 'Lava Louças 10 Serviços Slim Branca','BRASTEMP',  2449.00,    40, 'ct09', '67457503000161', '67457503000161', 'Nome da marca: Brastemp, Peso do produto	45,4 g, Dimensões do produto: 10 x 10 x 10 cm, Número da peça: 1168, Voltagem: 220 volts, Peso: 45.4 g');
INSERT into PRODUTO values('pr00000023', 'Como as democracias morrem',      'ZAHAR',        42.00,      20, 'ct10', '63557512000135', '63557512000135', 'Capa comum: 272 páginas, Editora: Zahar; Edição: 1ª, Idioma: Português, ISBN-10: 9788537818008, ISBN-13: 978-8537818008, ASIN: 8537818003, Dimensões do produto: 22,9 x 16 x 1,8 cm');
